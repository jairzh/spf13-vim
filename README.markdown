...
```bash
    ...
    curl https://raw.githubusercontent.com/jairzh/spf13-vim/3.0/bootstrap.sh -L > spf13-vim.sh && sh spf13-vim.sh
...
```bash
    ...
    sh <(curl https://raw.githubusercontent.com/jairzh/spf13-vim/3.0/bootstrap.sh -L)
...
```bash
    ...
    curl https://raw.githubusercontent.com/jairzh/spf13-vim/3.0/bootstrap.sh -L -o - | sh
